...
Answer: yes there is a very clear positive linear relationship with only a few outliers.
#### Challenge
...
- In the code chunk below titled `parsnip-spec`, replace "r" with "r" just before the code chunk title.
...
- In the code chunk below titled `glance-lm`, replace "r" with "r" just before the code chunk title. 
